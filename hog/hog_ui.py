...
def fuzzy_update_and_print(num_rolls, player_score, opponent_score, dice):
    """Return the updated score, print out the score update, and print when
    Fuzzy Factors is triggered.

    >>> d = printing_dice(make_test_dice(4, 5, 2))
    >>> fuzzy_update_and_print(3, 9, 99, d)
      [ 4 5 2 ] => 11; 9 + 11 = 20 triggering **Fuzzy Factors**, increasing to 24
    24
    """
    print('  [', end=" ")
    ...
    fuzzy_score = fuzzy_points(score)
    if fuzzy_score != score:
        score = fuzzy_score
        print(' triggering **Fuzzy Factors**, increasing to', score)
    else:
